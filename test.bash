...
curl --silent -o - http://127.0.0.1:9080/sample.pdf | sha1sum | grep "$SHA_SMALL_FILE" && echo "WORKS OK"
echo
...
curl --silent -o - http://127.0.0.1:9080/ICAPeg-DS.pdf | sha1sum | grep "$SHA_LARGE_FILE" && echo "WORKS OK"
echo
